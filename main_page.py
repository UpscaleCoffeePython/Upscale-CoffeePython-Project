...
def summary():
    ...
    total_string = "<div> Total Amount for your Order is: {}".format(total_cart)
    ...
    customer_wallet_string = ["<div>Your Cash Amount is: {} paid through {}</div>".format(i["Amount"],i["Method"]) for i in customer_wallet]
    ...
    if bool(customer_wallet) == False:
        ...
        change_string = "<div> Your Change for the Order is: {} </div>".format(change)
